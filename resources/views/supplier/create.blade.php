            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('supplier.store') }} " method="POST">
                        ...
                        <div class="my-3">
                            <input value="{{ old('id_supplier') }}" type="text" name="id_supplier"
                                class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="ID SUPPLIER">
                            @error('id_supplier')
                        ...
                        <div class="my-3">
                            <input value="{{ old('pajak') }}" type="text" name="pajak"
