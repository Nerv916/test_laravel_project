            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('costumer.update',$costumer->id) }} " method="POST">
                        ...
                        <div class="my-3">
                            <input value="{{ old('name',$costumer->name) }}" type="text" name="name"
                        ...
                        <div class="my-3">
                            <input value="{{ old('alamat',$costumer->alamat) }}" type="text" name="alamat"
                        ...
                        <div class="my-3">
                            <input value="{{ old('pic',$costumer->pic) }}" type="text" name="pic"
                        ...
                        <div class="my-3">
                            <input value="{{ old('kontak',$costumer->kontak) }}" type="text" name="kontak"
                        ...
                        <div class="my-3">
                            <input value="{{ old('npwp',$costumer->npwp) }}" type="text" name="npwp"
